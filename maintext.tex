...
\begin{table}[!htbp]
    ...
    \begin{tabular}{ccccc}
        ...
        \midrule[1pt]
        g & 重力加速度 & m/s^{2}\\
        v_{missile} & 导弹的速度 & m/s\\
        v_{cloud} & 云团下沉速度 & m/s\\
        v_{drone} & 无人机的速度 & m/s\\
        v_{min} & 无人机飞行最低速度 & m/s\\
        v_{max} & 无人机飞行最高速度 & m/s\\
        R_{effective} & 有效遮蔽半径 & m\\
        T_{effective} & 有效遮蔽时间窗长度 & m\\
        interval & 最短投弹时间间隔 & s\\
        T_{end} & 导弹到达假目标时刻 & s\\
        t_{drop} & 无人机投弹时间 & s\\
        ...
        t_{burst} & 干扰弹爆炸时刻 & s\\
        P_{burst} & 干扰弹爆炸位置 & m\\
        M_{i}^{0} & 导弹i在初始时刻的位置 & m\\
        FY_{i}^{0} & 无人机i在初始时刻的位置 & m\\
        M_{i}^{t} & 导弹i在t时刻的位置 & m\\
        FY_{i}^{t} & 无人机i在t时刻的位置 & m\\
        fake & 假目标的位置 & m\\
        real & 真目标圆柱底面中心 & m\\
        R & 真目标圆柱的半径 & m\\
        H & 真目标圆柱的高度 & m\\
...
\begin{table}[h]
    ...
    \begin{tabular}{|c|c|c|c|c|c|}
        \toprule[1.5pt]
        烟幕干扰弹编号 & 投放时间 (s) & 投放点坐标 (s) & 起爆时间 (s) & 起爆点坐标 (m) & 覆盖区间 (s) & 有效遮蔽时间 (s) \\
        \midrule[1pt]
        弹\#1 & $0.00$ & $(17800.00, 0.00, 1800.00)$ & $0.00$ & $(17800.00, 0.00, 1800.00)$ & $[(4.85, 7.4)]$ & 2.55 \\
        弹\#2 & $1.00$ & $(17937.12, 11.89, 1800.00)$ & $1.00$ & $(17937.12, 11.89, 1800.00)$ & $[(1.0, 5.37)]$ & 4.37 \\
        弹\#3 & $2.86$ & $(18192.04, 33.99, 1800.00)$ & $4.12$ & $(18365.23, 49.01, 1792.18)$ & $[]$ & 0.00 \\
        \bottomrule[1.5pt]
    \end{tabular}
\end{table}
...
\textbf{问题三总体参数：}
\begin{itemize}
    \item 无人机航向 = 4.96°，速度 = 137.6 m/s
    \item 三团并集（严格）= 6.400 s
    \item 并集区间 = $[(1.0, 7.4)]$  
\end{itemize}
...
\begin{table}[h]
    \centering
    \caption{问题五的结果}
    \label{tab:problem5_result}
    \begin{tabular}{cccccccccc}
        \toprule[1.5pt]
        无人机 & 航向角(度) & 速度(m/s) & 弹号 & 投放时间 & 起爆时间 & 对M1并集时长(s) & 对M2并集时长(s) & 对M3并集时长(s) & 三导弹合计(s) \\
        \midrule[1pt]
        \multirow{3}{*}{FY1} & \multirow{3}{*}{5.0129} & \multirow{3}{*}{140} & 1 & 0.000295 & 0 & 6.4 & 0 & 0 & 6.4 \\
        & & & 2 & 1.001805 & 0 & 6.4 & 0 & 0 & 6.4 \\
        & & & 3 & 10.0974 & 1.208209 & 6.4 & 0 & 0 & 6.4 \\
        \midrule[1pt]
        \multirow{3}{*}{FY2} & \multirow{3}{*}{295.0733} & \multirow{3}{*}{127.02} & 1 & 7.91 & 0.609999999999999 & 0 & 3.80999999999992 & 1.46999999999997 & 5.27999999999989 \\
        & & & 2 & 13.14 & 2.68 & 0 & 3.80999999999992 & 1.46999999999997 & 5.27999999999989 \\
        & & & 3 & 25.33 & 6.5 & 0 & 3.80999999999992 & 1.46999999999997 & 5.27999999999989 \\
        \midrule[1pt]
        \multirow{3}{*}{FY3} & \multirow{3}{*}{91.3948} & \multirow{3}{*}{109.9994} & 1 & 23.77486 & 4.232581 & 2.82 & 2.59 & 0 & 5.41 \\
        & & & 2 & 27.19432 & 2.342137 & 2.82 & 2.59 & 0 & 5.41 \\
        & & & 3 & 28.35641 & 1.848465 & 2.82 & 2.59 & 0 & 5.41 \\
        \midrule[1pt]
        \multirow{3}{*}{FY4} & \multirow{3}{*}{0} & \multirow{3}{*}{70} & 1 & 0.92 & 0.5 & 0 & 0 & 0 & 0 \\
        & & & 2 & 1.920001 & 1.34 & 0 & 0 & 0 & 0 \\
        & & & 3 & 2.920002 & 0.5 & 0 & 0 & 0 & 0 \\
        \midrule[1pt]
        \multirow{3}{*}{FY5} & \multirow{3}{*}{120.1084} & \multirow{3}{*}{104.780075012597} & 1 & 15.962981755867 & 1.69564133891759 & 3.55000000000055 & 0 & 1.63000000000026 & 5.18000000000081 \\
        & & & 2 & 17.4937425545334 & 4.66689952580639 & 3.55000000000055 & 0 & 1.63000000000026 & 5.18000000000081 \\
        & & & 3 & 23.308526948921 & 1.37918367886234 & 3.55000000000055 & 0 & 1.63000000000026 & 5.18000000000081 \\
        \bottomrule[1.5pt]
    \end{tabular}
\end{table}
...
\begin{table}[h]
    ...
    \begin{tabular}{cc}
        \toprule[1.5pt]
        UAV & total\_cover\_sum\_s \\
        \midrule[1pt]
        FY1 & 6.4 \\
        FY2 & 5.27999999999989 \\
        FY3 & 5.41 \\
        FY4 & 0 \\
        FY5 & 5.18000000000081 \\
        \midrule[1pt]
        TOTAL & 22.27 \\
        \bottomrule[1.5pt]
    \end{tabular}
